...
namespace Amuse.UI.Models.StableDiffusion
{
    public class SchedulerOptionsModel : INotifyPropertyChanged
    {
        ...
        private int _inferenceSteps2 = 15;
        ...
        [Range(1, 200)]
        public int InferenceSteps2
        {
            get { return _inferenceSteps2; }
            set { _inferenceSteps2 = value; NotifyPropertyChanged(); }
        }
        ...
        public float GuidanceScale2
        {
            ...
            set { _guidanceScale2 = value; NotifyPropertyChanged(); }
        }
        ...
        public List<int> Timesteps
        {
            ...
            set { _timesteps = value; NotifyPropertyChanged(); }
        }
        ...
        public static SchedulerOptions ToSchedulerOptions(SchedulerOptionsModel model)
        {
            return new SchedulerOptions
            {
                ...
                GuidanceScale2 = model.GuidanceScale2,
                InferenceSteps2 = model.InferenceSteps2,
                Shift = model.Shift
            };
        }
